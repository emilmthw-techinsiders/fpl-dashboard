...
// unlike Goals/Assists/cards (naturally short), a single fixture can have
// 15-20+ nonzero entries for these two, which is unreadable in full on a
// gameweek summary. Top 5 by value covers who actually mattered.
const TOP_N_STATS = { bps: 5, defensive_contribution: 5 };
