...
// Newly-promoted teams (no top-flight fixtures last season) simply won't
// have an entry here — callers must treat a missing team as "unknown",
// never fabricate a number for it.
...
// should just mean "no Elo signal this run", not a broken refresh.
