...
IMPORTANT: this data is fetched fresh right now, more current than anything you already "know" about these clubs/players from training — a squad list, an injury, or a transfer you recall may be outdated. Treat every fact below as the current ground truth; if your own recollection conflicts with it, the data below wins, always.
