...
// as lib/eloRatings.mjs and lib/friendlies. No API key, no per-call cost.
//
...
// missing map exactly like a missing friendlies/elo fetch: just skip the
// enrichment, never break the refresh.
